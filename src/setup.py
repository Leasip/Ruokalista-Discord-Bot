...
bot_token= str(input("please input your bot token: "))
bot_token ="bot_token = \"" + bot_token + "\""
channel_id= str(input("please input the channel id you want to send the message to: "))
channel_id ="channel_id = \"" + channel_id + "\""
debug_channel_id= str(input("please input the debug channel id: "))
